...
use super::widgets::quick_launch;
use super::widgets::terminal::TerminalEvent;
use crate::app::Event;
...
pub(crate) fn context_menu_guard(event: &Event) -> MenuGuard {
    ...
    match event {
        Event::SidebarUi(SidebarUiEvent::Workspace(
        ...
        | Event::SidebarUi(SidebarUiEvent::PaneGridCursorMoved { .. })
        | Event::ExplorerUi(_)
        | Event::ExplorerEffect(_) => Allow,
...
pub(crate) fn inline_edit_guard(event: &Event) -> bool {
    ...
    match event {
        ...
        Event::SidebarUi(SidebarUiEvent::PaneGridCursorMoved { .. }) => false,
...
mod tests {
    ...
    fn given_sidebar_quick_launch_node_release_when_context_menu_guard_runs_then_event_is_ignored()
     {
        let guard = context_menu_guard(&Event::SidebarUi(
            SidebarUiEvent::Workspace(SidebarWorkspaceEvent::QuickLaunch(
    ...
    fn given_sidebar_add_menu_open_when_context_menu_guard_runs_then_event_is_ignored()
     {
        let guard =
            context_menu_guard(&Event::SidebarUi(SidebarUiEvent::Workspace(
