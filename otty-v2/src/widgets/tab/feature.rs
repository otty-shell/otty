...
use crate::widgets::quick_launch::{self, QuickLaunchEvent};
use crate::widgets::quick_launch_wizard::QuickLaunchWizardUiEvent;
...
impl TabFeature {
    ...
    fn close_tab(&mut self, tab_id: u64) -> Task<AppEvent> {
        ...
        let mut tasks = vec![
            ...
            Task::done(AppEvent::QuickLaunchWizardUi {
                tab_id,
                event: QuickLaunchWizardUiEvent::TabClosed,
            }),
        ...
        tasks.push(Task::done(AppEvent::ExplorerUi(
            ExplorerUiEvent::SyncFromActiveTerminal,
        )));
    ...
    fn open_quick_launch_wizard_create_tab(
        ...
        Task::done(AppEvent::QuickLaunchWizardUi {
            tab_id,
            event: QuickLaunchWizardUiEvent::InitializeCreate { parent_path },
        })
    }
    ...
    fn open_quick_launch_wizard_edit_tab(
        ...
        Task::done(AppEvent::QuickLaunchWizardUi {
            tab_id,
            event: QuickLaunchWizardUiEvent::InitializeEdit {
                path,
...
mod tests {
    use super::*;
    use crate::widgets::terminal::fallback_shell_session_with_shell;
