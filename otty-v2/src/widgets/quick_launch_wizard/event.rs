use crate::widgets::quick_launch::{
    QuickLaunch, QuickLaunchType, QuickLaunchWizardSaveRequest,
};

/// UI-level events handled by quick-launch wizard router.
#[derive(Debug, Clone)]
pub(crate) enum QuickLaunchWizardUiEvent {
    InitializeCreate {
...
/// Side-effect events emitted by quick-launch wizard reducer.
#[derive(Debug, Clone)]
pub(crate) enum QuickLaunchWizardEffectEvent {
