...
impl ConptyApi {
    ...
    fn load_conpty() -> Option<Self> {
        ...
        unsafe {
            ...
            Some(Self {
                create: mem::transmute::<LoadedFn, CreatePseudoConsoleFn>(
                    create_fn,
                ),
                resize: mem::transmute::<LoadedFn, ResizePseudoConsoleFn>(
                    resize_fn,
                ),
                close: mem::transmute::<LoadedFn, ClosePseudoConsoleFn>(
                    close_fn,
                ),
            })
        }
