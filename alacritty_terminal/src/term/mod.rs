...
use otty_escape::{
    Action, Actor, CharacterAttribute, Charset, CharsetIndex, ClearMode, Color,
    CursorShape, CursorStyle, Hyperlink, KeyboardMode,
...
//     Hyperlink, KeyboardMode, KeyboardModeApplyBehavior, NamedColor,
...
impl From<KeyboardMode> for TermMode {
...
impl<T> Term<T> {
        ...
        T: EventListener,
    {
        ...
        self.handle(Action::SetScrollingRegion(1, self.screen_lines()));
