...
use super::event::QuickLaunchWizardEvent;
...
impl QuickLaunchWizardFeature {
    ...
    pub(crate) fn reduce(
        ...
        match event {
            ...
            Cancel => Task::done(AppEvent::CloseTabRequested { tab_id }),
...
impl QuickLaunchWizardFeature {
    ...
    fn reduce_save(&mut self, tab_id: u64) -> Task<AppEvent> {
...
mod tests {
    ...
    fn given_custom_editor_when_field_events_are_reduced_then_state_is_updated()
    {
        ...
        let _ = feature.reduce(QuickLaunchWizardEvent::AddArg, &ctx(tab_id));
        let _ = feature.reduce(
        ...
        let _ = feature.reduce(QuickLaunchWizardEvent::AddEnv, &ctx(tab_id));
        let _ = feature.reduce(
    ...
    fn given_edit_editor_when_selecting_type_then_existing_type_is_preserved() {
        ...
        let command = crate::features::quick_launch::QuickLaunch {
    ...
    fn given_invalid_editor_when_save_then_error_is_set() {
        ...
        let _ = feature.reduce(QuickLaunchWizardEvent::Save, &ctx(tab_id));
