...
fn default_keyboard_bindings() -> Vec<(Binding<InputKind>, BindingAction)> {
    generate_bindings!(
        ...
        End,        ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[F".into());
        Home,       ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[H".into());
        ArrowUp,    ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[A".into());
        ArrowDown,  ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[B".into());
        ArrowLeft,  ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[D".into());
        ArrowRight, ~SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1b[C".into());
        // APP_CURSOR Including
        End,        +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1BOF".into());
        Home,       +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1BOH".into());
        ArrowUp,    +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1bOA".into());
        ArrowDown,  +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1bOB".into());
        ArrowLeft,  +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1bOD".into());
        ArrowRight, +SurfaceMode::APP_CURSOR; BindingAction::Esc("\x1bOC".into());
        // CTRL
        ...
        End,        Modifiers::SHIFT, +SurfaceMode::ALT_SCREEN; BindingAction::Esc("\x1b[1;2F".into());
        Home,       Modifiers::SHIFT, +SurfaceMode::ALT_SCREEN; BindingAction::Esc("\x1b[1;2H".into());
        PageUp,     Modifiers::SHIFT, +SurfaceMode::ALT_SCREEN; BindingAction::Esc("\x1b[5;2~".into());
        PageDown,   Modifiers::SHIFT, +SurfaceMode::ALT_SCREEN; BindingAction::Esc("\x1b[6;2~".into());
...
mod tests {
    ...
    fn add_many_new_custom_keyboard_bindings() {
        ...
        let custom_bindings = generate_bindings!(
            KeyboardBinding;
            ArrowDown, Modifiers::ALT, +SurfaceMode::SGR_MOUSE; BindingAction::LinkOpen;
