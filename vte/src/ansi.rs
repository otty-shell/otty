...
mod tests {
    ...
    #[test]
    fn parse_osc10_set_foreground_hex() {
        // OSC 10 ; #RRGGBB ST
        let bytes: &[u8] = b"\x1b]10;#112233\x1b\\";
        ...
        assert_eq!(handler.color, Some(Rgb { r: 0x11, g: 0x22, b: 0x33 }));
    }

    #[test]
    fn parse_osc11_set_background_rgb_notation() {
        // OSC 11 ; rgb:f/e/d ST  ->  FF EE DD
        let bytes: &[u8] = b"\x1b]11;rgb:f/e/d\x1b\\";
        ...
        assert_eq!(handler.color, Some(Rgb { r: 0xFF, g: 0xEE, b: 0xDD }));
    }

    #[test]
    fn parse_osc12_set_cursor_truecolor_short_hex() {
        // Короткая hex-форма (#abc  =>  #a0 b0 c0)
        let bytes: &[u8] = b"\x1b]12;#abc\x1b\\";
        ...
        assert_eq!(handler.color, Some(Rgb { r: 0xA0, g: 0xB0, b: 0xC0 }));
    }
